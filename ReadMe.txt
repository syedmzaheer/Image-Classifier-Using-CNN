# Image Classification using Convolutional Neural Network (CNNs)
classification of images using Convolutional Neural Networks (CNN)

#### Dataset used: CIFAR-10 (A Large Scale Remote Sensing Image Classification Benchmark via Crowdsource Data)
